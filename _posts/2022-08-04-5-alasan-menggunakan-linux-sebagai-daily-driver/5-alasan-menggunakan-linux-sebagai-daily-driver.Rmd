...
```{r echo=FALSE, out.width='100%', fig.link="https://www.computerbild.de/artikel/cb-Tipps-Software-Linux-statt-Windows-11-Diese-Distribution-zentriert-Startbutton-und-Symbole-ebenfalls-30722397.html"}
knitr::include_graphics('../../img_parrent/linux.jpg')
```
