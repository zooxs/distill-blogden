...
preview: ../../img_parrent/python_environtmen.png
---
...
knitr::include_graphics("../../img_parrent/python_environtmen.png")
```
...
## PyCharm
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics("../../img_parrent/python_pycharm.jpg")
```
...
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics("../../img_parrent/python_pycharm_landing.png")
```

## Anaconda

```{r echo=FALSE, out.width='100%'}
knitr::include_graphics("../../img_parrent/python_anaconda.jpg")
```
...
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics("../../img_parrent/python_anaconda_nav.png")
```
# *Code/Text Editor*
...
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics("../../img_parrent/vscode-dev.png")
```
...
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics("../../img_parrent/neovim.png")
```
# *Online Tools*
...
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics("../../img_parrent/google_collab_ss.png")
```

```{r echo=FALSE, out.width='100%'}
knitr::include_graphics("../../img_parrent/kaggle_ss.png")
```