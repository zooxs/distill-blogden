...
Tipe data setiap kolom dapat diketahui menggunakan atribut `.columns` pada dataset.
...
Terdapat dua cara umum untul memanggil data pada kolom tertentu, menggunakan nama kolom sebagai indeks dan menggunakan nama kolom sebagai atribut.
...
Nilai tersebut dapat ditentukan dengan metode `.meand()` dan `.std()`.
...
## Nilai kauntil
Nilai kuantil dapat ditentukan dengan metode `.quantile()`. Q10, Q20 maupun Q30 bisa diketahui dengan memasukkan parameter pada metode `.quatile(.10)`, `.quatile(.20)` dan `.quatile(.30)` untuk masing-masing nilai kuantil yang ingin dicari.
