...
description: |
  Cara yang umum digunakan dalam memfilter data menggunakan Pandas.
author:
...
output:
  distill::distill_article:
    ...
    toc: true
preview: ../../img_parrent/pandas_tb_filter.png
---

```{r echo=FALSE, out.width='100%'}
knitr::include_graphics("../../img_parrent/pandas_tb_filter.png")
```
